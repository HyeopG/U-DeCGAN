...
class DCGAN(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, norm="bnorm"):
        ...
        self.dec5 = DECBR2d(1 * nker, out_channels, kernel_size=4, stride=2, padding=1, norm=None, relu=None, bias=False)
...
class Discriminator(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, norm="bnorm"):
        ...
        self.enc5 = CBR2d(8 * nker, 16 * nker, kernel_size=4, stride=2, padding=1, norm=norm, relu=0.2, bias=False)
        self.enc6 = CBR2d(16 * nker, out_channels, kernel_size=4, stride=1, padding=0, norm=None, relu=None, bias=False)
...
class UNet(nn.Module):
    def __init__(self, in_channels, out_channels, nker, norm="bnorm", learning_type="plain"):
...
class ResNet(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, learning_type="plain", norm="bnorm", nblk=16):
        ...
        self.enc = CBR2d(in_channels=in_channels, out_channels=nker, kernel_size=3, stride=1, padding=1, bias=True, norm=None, relu=0.0)
